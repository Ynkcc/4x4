...
class ContinuousTrainer:
    ...
    def train_session(self, model_path: str) -> str:
        ...
        try:
            ...
            # 备份当前模型
            if os.path.exists(self.CURRENT_MODEL_PATH):
                os.rename(self.CURRENT_MODEL_PATH, self.BACKUP_MODEL_PATH)
    ...
    def run_continuous_training(self):
        ...
        if post_winrate > self.best_winrate:
            ...
            if os.path.exists(trained_model):
                os.system(f"cp {trained_model} {best_model_path}")
        ...
        if improvement > 0:
            ...
            print(f"   ⚠️ 本次训练胜率未提升，可能需要调整参数或已接近收敛")
